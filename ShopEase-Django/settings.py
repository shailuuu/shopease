...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'development-only-change-this-secret-key')
DEBUG = os.environ.get('DJANGO_DEBUG', '1') == '1'
_hosts = ['127.0.0.1', 'localhost', '10.226.211.127']
_hosts += [host.strip() for host in os.environ.get('ALLOWED_HOSTS', '').split(',') if host.strip()]
if os.environ.get('RENDER_EXTERNAL_HOSTNAME'):
    _hosts.append(os.environ['RENDER_EXTERNAL_HOSTNAME'])
